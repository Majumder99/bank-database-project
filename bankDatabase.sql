...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Last name: '|| ACC_NO);
END;
/
SHOW ERRORS;
...
INSERT INTO CREDIT_CARD(CARD_NUMBER, CARD_LIMIT, EXPIRE_DATE, CUSTOMER_ID) VALUES(1009, 50000, '2022-05-24', 502);

-- DOES INSERT

INSERT INTO CREDIT_CARD(CARD_NUMBER, CARD_LIMIT, EXPIRE_DATE, CUSTOMER_ID) VALUES(1011, 600000, '2022-05-24', 504);
